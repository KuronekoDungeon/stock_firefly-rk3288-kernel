...
KERNELFLAGS	= -fgcse-lm -fgcse-sm -fsched-spec-load -fforce-addr -ffast-math -fsingle-precision-constant \
		  -march=armv7-a -mtune=cortex-a15 -marm -mfpu=neon-vfpv4 -ftree-vectorize \
